...
export class CouldNotRetrieveTranscript extends YouTubeTranscriptApiException {
  constructor(videoId) {
    ...
    this.CAUSE_MESSAGE = '';
    this.GITHUB_REFERRAL = '\n\nIf you are sure that the described cause is not responsible for this error and that a transcript should be retrievable, please create an issue at our github repository.';
  }
